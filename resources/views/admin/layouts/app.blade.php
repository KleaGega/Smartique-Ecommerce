                        ...
                        <div class="d-flex flex-column align-items-start px-3 pt-2 min-vh-100">
                            <ul class="nav nav-pills flex-column mb-auto w-100">
                                ...
                                <li class="nav-item mb-2">
                                    <a href="#submenu1Mobile" data-bs-toggle="collapse" class="nav-link text-white">
                                        <i class="icofont icofont-food-basket fs-5"></i> <span class="ms-2">Products</span>
                                    </a>
                                    <div class="collapse" id="submenu1Mobile">
                                        <ul class="nav flex-column ms-3">
                                            <li class="nav-item">
                                                <a href="/admin/products" class="nav-link text-white py-1">All Products</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="/admin/products/create" class="nav-link text-white py-1">Add Product</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item mb-2">
                                    <a href="/admin/users/distribution" class="nav-link text-white">
                                        <i class="icofont icofont-chart-bar-graph fs-5"></i> <span class="ms-2">User Distribution</span>
                                    </a>
                                </li>
                            </ul>
                            <hr class="w-100">
                            <div class="dropdown pb-4 w-100">
                                <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUserMobile" data-bs-toggle="dropdown" aria-expanded="false">
                                    <span class="mx-1">{{get_logged_in_user()->username}}</span>
                                </a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item">
                                    <span class="nav-link">Welcome, {{get_logged_in_user()->username}}!</span>
                                </li>
                            </ul>
                            <div class="d-flex">
