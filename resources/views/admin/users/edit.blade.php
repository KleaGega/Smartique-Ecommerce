                ...
                <div class="card-body p-4 p-md-5 text-sm">
                    ...
                    <form action="/admin/users/{{ $user->id }}/update/" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="fullname" class="form-control form-control-lg border-0 bg-light" value="{{ $user->fullname }}" required>
                            <div class="form-text">User's complete name</div>
                        </div>
                        <div class="mb-4">
                            <label for="username" class="form-label">Username</label>
                            <input type="text" name="username" class="form-control border-0 bg-light" value="{{ $user->username }}" required>
